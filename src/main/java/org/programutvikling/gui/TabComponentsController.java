...
public class TabComponentsController {
    ...
    public void initialize() throws IOException {
        ...
        this.tblViewComponent.setOnMouseClicked((MouseEvent event) -> setSceneKeyEventListener() );
    }

    private void setSceneKeyEventListener() {
        this.scene=topLevelPane.getScene();
        if(!alreadyExecuted) {
